                    ...
                    <table class="table table-bordered" id="admin_table">
                        ...
                        @foreach($infos as $info)
                            <tr>
                                <td>{{ $info->nama }}</td>
                                <td>
                                <button type="button" class="btn btn-sm btn-default" data-toggle="modal" data-target="#modal-{{ $info->id }}">
                                    Lihat
                                </button>
                                ...
                                <td>
                                <button type="button" class="btn btn-sm btn-default" data-toggle="modal" data-target="#modal1-{{ $info->id }}">
                                    Lihat
                                </button>
                                <div class="modal fade" id="modal1-{{ $info->id }}">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-body" style="display: block;">
                                            @php
                                              $string = 'Data/Informasi/'.$info->gambar;
                                            @endphp
                                                <img src="{{$string}}" width="100%" height="auto" frameborder="0" style="margin-left: auto; margin-right: auto; display:block;"></img>
                                        </div>
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                            {{-- <button type="button" class="btn btn-primary">Save changes</button> --}}
