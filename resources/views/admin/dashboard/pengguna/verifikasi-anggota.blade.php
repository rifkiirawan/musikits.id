...
<div class="content-wrapper">
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
            <h1>VERIFIKASI PENGGUNA ANGGOTA</h1>
            </div>
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item">Pengguna</li>
                <li class="breadcrumb-item text-blue"><a href="{{ route('list-new-account-anggota') }}">Verifikasi Pengguna Anggota</a></li>
            </ol>
            </div>
        </div>
        </div><!-- /.container-fluid -->
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn btn-sm btn-warning" data-dismiss="modal">Tidak</button>
                                            <form action="{{ route('anggota.reject', $user->id) }}" method="post">
                                                {{ csrf_field() }}
                                                {{ method_field('put') }}
