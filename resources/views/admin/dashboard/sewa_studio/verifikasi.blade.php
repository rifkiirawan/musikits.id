...
<div class="content-wrapper">
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
            <h1>VERIFIKASI SEWA STUDIO</h1>
            </div>
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item">Sewa Studio</li>
                <li class="breadcrumb-item text-blue"><a href="{{ route('list-new-booking-studio') }}">Verifikasi Sewa Studio</a></li>
            </ol>
            </div>
        </div>
        </div><!-- /.container-fluid -->
                            ...
                            <tr>
                                ...
                                <div class="modal fade" id="modal1-{{ $booking->id }}">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            ...
                                            <form action="{{ route('booking.studio.approve', $booking->id) }}" method="post">
                                                {{ csrf_field() }}
                                                {{ method_field('put') }}
                                ...
                                <td>
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn btn-sm btn-warning" data-dismiss="modal">Tidak</button>
                                            <form action="{{ route('booking.studio.reject', $booking->id) }}" method="post">
                                                {{ csrf_field() }}
                                                {{ method_field('put') }}
